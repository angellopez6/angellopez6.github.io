...
<html lang="en">
  <head>
    ...
    <title>Interés Simple | Calculadora</title>
  </head>
  <body>
      ...
      <div class='alert alert-danger alert-dismissible fade show' role='alert' style="margin:0;">
        ...
        <a class="nav-link" href="index.php">Documentación <span class="sr-only">(current)</span></a>
              ...
              <li class="nav-item active">
                <a class="nav-link" href="#">Interés Simple</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container-fluid">
     ...
     <div class="row">
            ...
            <div class="col">
                ...
                <center><h2>Calculadora de Interés Simple</h2></center>
     ...
     <div class="row fila-s-2">
            ...
            <h6 class="align-justify">
                ...
                Solo el capital genera intereses.
                Los intereses devengados en periodos anteriores
                no generan intereses en periodos posteriores.
     ...
     <br>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Interés Simple</h5>
                ...
                <div class="modal-body">
                    ...
                    Para calcular el interés simple se requieren datos como: El capital inicial, porcentaje de la tasa de interés y el tiempo
            ...
            <div class="row">
                    ...
                    <div class="col-7 fila-s-tabla">
                            ...
                            <tbody>
                                ...
                                <td>
                                  ...
                                  <div class="input-group mb-3">
                                    <select class="custom-select" name="i_s_moneda" id="inputGroupSelect02" required>
                                ...
                                <td>
                                    <div class="input-group">
                                    <input type="number" name="i_s_capital_i" step="0.01" class="form-control" aria-label="Dollar amount (with dot and two decimal places)" min="0" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                                        <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-cash" fill="green" xmlns="http://www.w3.org/2000/svg">
                                          <path fill-rule="evenodd" d="M15 4H1v8h14V4zM1 3a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H1z"/>
                                ...
                                <td>
                                    <div class="input-group">
                                    <input type="number" name="i_s_tasa_i" step="0.01" class="form-control" aria-label="Dollar amount (with dot and two decimal places)" min="0" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                                            <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-percent" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                              <path fill-rule="evenodd" d="M13.442 2.558a.625.625 0 0 1 0 .884l-10 10a.625.625 0 1 1-.884-.884l10-10a.625.625 0 0 1 .884 0zM4.5 6a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm0 1a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5zm7 6a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm0 1a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
                                        ...
                                        <span class="input-group-text">
                                          ...
                                          <select name="i_s_frecuencia_tasa" id="i_s_frecuencia_tasa" required>
                                ...
                                <td>
                                    <div class="input-group">
                                    <input type="number" name="i_s_tiempo" step="0.01" class="form-control" aria-label="Dollar amount (with dot and two decimal places)" min="0" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                                        ...
                                        <span class="input-group-text">
                                          ...
                                          <select name="i_s_frecuencia_tiempo" id="i_s_frecuencia_tiempo" required>
                            ...
                            <center><button class="btn btn-outline-primary btn-lg btn-block" type="submit" value="Calcular" name="i_s_calcular" id="Calcular">Calcular</button></center>
                            <br>
                            </form>
            ...
            if(isset($datos)){?>
              ...
              <br>
                      ...
                      <div class="row">
                        ...
                        <h5>Intereses Generados: <?php echo $datos['Interés'] . " " . $datos['Moneda']?></h5>
                        <tbody>
                          <?php
                          ...
                          <tr>
                            ...
                            <td><?php echo number_format($capital_i) . " " . $datos['Moneda']; ?></td>
                            <td><?php echo number_format(round($capital_i*$datos['Tasa'],2)) . " " . $datos['Moneda']; ?></td>
                            <td><?php echo number_format(round(($datos['Capital Inicial']+=$capital_i*$datos['Tasa']),2)) . " " . $datos['Moneda']; ?></td>
                          </tr>
